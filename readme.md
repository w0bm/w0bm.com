...
3. Create a .env file inside of w0bm.com/ with your database information ([Example](https://github.com/laravel/laravel/blob/master/.env.example)) and set the `APP_KEY` with `php artisan key:generate` (you need to have `APP_KEY=SomeRandomStringWith32Characters` in your `.env`)
