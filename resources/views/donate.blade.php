...
<div class="col-md-6">
	...
	<div class="progress">
  		<div class="progress-bar-success" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="90" style="text-align:center; color:white; width: 59%;">
		59,17€
		</div>
	</div>
  ...
  <table class="col-xs-6 table table-condensed" style="border-collapse: collapse;">
	...
	<tr class="success">
            <td>1.</td>
            <td><a href="/user/FliesentischKing"</a>FliesentischKing</td>
            <td>5,95€</td>
	    <td>PayPal</td>
	    <td>21.09.2016</td>
        </tr>
	...
	<tr class="success">
            <td>3.</td>
            <td><a href="/user/flinny">flinny</a></td>
            <td>26,12€</td>
	    <td>PayPal</td>
	    <td>22.09.2016</td>
        </tr>
	...
	<tr class="success">
            <td>5.</td>
            <td><a href="/user/smetbo">smetbo</a></td>
            <td>10€</td>
	    <td>PayPal</td>
	    <td>22.09.2016</td>
        </tr>
	...
	<tr class="success">
            <td>10.</td>
            <td><a href="/user/weissbier">weissbier</a></td>
            <td>13,37€</td>
	    <td>PayPal</td>
	    <td>25.09.2016</td>
        </tr>
	...
	<tr class="success">
            <td>11.</td>
            <td><a href="/user/IDeclareWar">IDeclareWar</a></td>
            <td>6€</td>
	    <td>PayPal</td>
	    <td>25.09.2016</td>
        </tr>
