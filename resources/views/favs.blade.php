...
@section('content')
        ...
        <h3>{{$user->username}}@if($user->is('Moderator')) <span class="" style="color: #1FB2B0;"><i class="fa fa-bolt anim"></i></span>@elseif($user->is('Editor'))  <span class="" style="color: #1FB2B0;"><i class="fa fa-shield anim"></i></span>@elseif($user->is('flinny')) <img class="flinny" src="{{ asset('wizard.png') }}"></img>@elseif($user->is('brown')) <img class="rain" src="{{ asset('watermelon.png') }}"></img>@elseif($user->is('dank')) <img class="dank" src="{{ asset('weed.png') }}"></img>@elseif($user->is('gay')) <img class="gay" src="{{ asset('gaypride.svg') }}"></img>@endif<h3> 
