        ...
        <div class="wrapper">
            ...
            @if($category)
                <div class="text-center" style="position: unset;">
                    ...
                    @else
                        <a class="first" href="{{url($video::whereCategoryId($video->category->id)->first()->id)}}">← first</a>
                    ...
                    @else
                        ...
                        <a class="last" href="{{url($video::whereCategoryId($video->category->id)->max('id'))}}">last →</a>
                    @endif
