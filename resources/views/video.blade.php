				...
				<span class="videoinfo">
						...
						<button class="fa fa-info-circle"
							...
							data-content="	<div style='word-break: break-word;'>@if($video->interpret) <strong>Artist:</strong> {{$video->interpret}}<br>@endif
											...
											@if($video->category->name == 'Anime') <div class='whatanime'><a href='https://whatanime.ga/?url=https://w0bm.com/thumbs/{{str_replace('.webm','',$video->file)}}.gif'>whatanime?</a></div> @endif
											">
						</button>
